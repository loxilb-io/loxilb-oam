# loxilb-oam Governance

`loxilb-oam` is part of the [LoxiLB](https://github.com/loxilb-io) project and follows the LoxiLB
...
loxilb-oam Maintainers have write access to the
[loxilb-oam GitHub repository](https://github.com/loxilb-io/loxilb-oam). They review and merge pull
