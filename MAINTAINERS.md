# loxilb-oam Maintainers

This is the current list of maintainers for the loxilb-oam project. See
...
<!--
  ...
  files and grant/revoke the corresponding GitHub write access. Confirm the roster for loxilb-oam
  specifically — it is seeded from the LoxiLB Maintainer Council and may differ.
-->

If any person or organization wants to become a maintainer of loxilb-oam, please review the
